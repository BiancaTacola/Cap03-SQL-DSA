#Query com todas as transformações. Depois criamos uma nova tabela, considerando todos esses dados transformados
...
SELECT
   ...
   CASE
	...
	END as quadrante,
    CASE
		WHEN irradiano= 'no' THEN 0
        WHEN irradiano= 'yes' THEN 1
	END as irradiano
FROM cap03.tb_dados;
